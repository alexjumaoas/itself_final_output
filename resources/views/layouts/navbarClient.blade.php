...
<ul class="nav nav-line nav-color-secondary" style="margin-left: 15%;">   <!-- style="margin-left: 25.3%;" -->
    <li class="nav-item">
        <a class="nav-link {{ request()->routeIs('requestForm') ? 'active' : '' }}" href="{{ route('requestForm') }}">Home</a>
    </li>
    <li class="nav-item">
        <a class="nav-link {{ request()->routeIs('currentRequest') ? 'active' : '' }}" href="{{ route('currentRequest') }}">Request(s)</a>
    </li>
</ul>
                ...
                <li>
                    <div class="user-box">
                        ...
                        <div class="u-text">
                            ...
                            <p class="text-muted">ICTU Office of the RD / ARD</p>
                            <!-- <a
                                href="profile.html"
